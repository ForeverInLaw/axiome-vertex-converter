...
### Шаг 2: Получить Telegram API credentials (для поддержки файлов до 2 GB)

⚠️ **ОБЯЗАТЕЛЬНО!** Без этих параметров бот не поддерживает файлы больше 20 МБ.
...
💡 Эти параметры нужны для локального Bot API Server, который обходит лимит Telegram в 20 МБ.
...
# Вставьте API credentials из my.telegram.org/apps
...
### Шаг 4: Установить зависимости (опционально для разработки)
...
⏱️ Первый запуск занимает 2-3 минуты (скачивание образов, сборка).
...
2. Отправьте `/start`
3. Отправьте любой файл (до **2 GB**!)
4. Выберите формат и качество
5. Получите результат! 🎉

✨ **Локальный Bot API Server включен!** Поддержка файлов до 2 GB.
